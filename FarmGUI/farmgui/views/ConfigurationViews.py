...
class ConfigurationViews(object):
    ...
    def components_list(self):
        ...
        add_form = Form(FarmComponentSchema(), formid='addForm', buttons=('Save',))
    ...
    def component_delete(self):
        comp = DBSession.query(FarmComponent).filter(FarmComponent.id == self.request.matchdict['_id']).first()
